using AhmadProject.Application.Common.Persistence;
using AhmadProject.Domain.Common.Contracts;
using AhmadProject.Infrastructure.Common;
using AhmadProject.Infrastructure.Persistence.ConnectionString;
using AhmadProject.Infrastructure.Persistence.Context;
using AhmadProject.Infrastructure.Persistence.Initialization;
using AhmadProject.Infrastructure.Persistence.Repository;
...
namespace AhmadProject.Infrastructure.Persistence;
